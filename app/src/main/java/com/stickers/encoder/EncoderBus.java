...
public class EncoderBus {
    ...
    public void onProcessResults(String tag, Object object1) {
        for (int i = 0; i < encoders.size(); i++) {
            encoders.get(i).processResults(tag, object1);
        }
    }

    public void onProcessResults(String tag, Object object1, Object object2) {
        for (int i = 0; i < encoders.size(); i++) {
            encoders.get(i).processResults(tag, object1, object2);
        }
    }
}
